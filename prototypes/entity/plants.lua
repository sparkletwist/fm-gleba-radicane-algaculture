...
data:extend({
	{
		...
		minable = {
			...
			mining_time = 0.2,
			results = {{type="item", name="water-cane", amount=2}},
			mining_trigger = {
				{
					type = "direct",
					action_delivery = {
	...
	},
	{
		...
		minable = {
			...
			mining_particle = "wooden-particle",
			mining_time = 0.2,
			results = {{type="item", name="radicane", amount=5}},
			mining_trigger = {
				{
					type = "direct",
					action_delivery = {
		...
		map_color = {0.19, 0.69, 0.19, 0.60},
		agricultural_tower_tint = {
			primary = {r=0.6, g=1.0, b=0.2, a=1},
			secondary = {r=0.561, g=0.913, b=0.308, a=1.000},
		},
